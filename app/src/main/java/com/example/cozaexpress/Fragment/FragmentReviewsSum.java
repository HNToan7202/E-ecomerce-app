...
public class FragmentReviewsSum extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_reviewsum, container, false);
        rc_Feedback = view.findViewById(R.id.rc_FeedbackSum);
